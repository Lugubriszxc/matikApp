...
--
ALTER TABLE `assignsubject`
  MODIFY `a_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=473;
...
--
ALTER TABLE `instructorunitload`
  MODIFY `unitLoadID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;

--
-- AUTO_INCREMENT for table `regissection`
--
ALTER TABLE `regissection`
  MODIFY `regisSectionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
...
--
ALTER TABLE `roomschedule`
  MODIFY `roomSchedID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60821;
