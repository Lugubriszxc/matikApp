...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2023 at 03:04 PM
...
(17, 'College of asd', 6),
(24, 'Bachelor of Ambot', 16),
(25, 'Bachelor of Testing ra gud', 16);
...
(4, 'Room 2', 'Computer Laboratory', 60, 1),
(5, 'Speech Lab 1', 'Speech Laboratory', 60, 3),
(6, 'Science Laboratory 1', 'Science Laboratory', 30, 1);
...
(1, 'BSIT-1A', '1st Year', 1, 1),
(2, 'BSIT-1B', '1st Year', 1, 1),
(3, 'BSIT-1C', '1st Year', 1, 1),
(5, 'BSIT-2A', '2nd Year', 1, 1),
(6, 'CRIM-1A', '1st Year', 3, 8),
(7, 'BEED-1A', '1st Year', 2, 3),
(8, 'BEED-2A', '2nd Year', 2, 3);
...
(5, 'CC101', 'System Administration and Maintenance', 'Computer Laboratory', 5, 150),
(6, 'CAPSTONE 1', 'Capstone Project 1', 'Computer Laboratory', 5, 150);
...
(9, 'Monday', '08:00', '10:30'),
(10, 'Tuesday', '13:00', '15:30');
...
--
ALTER TABLE `dean`
  MODIFY `deanID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
