...
(17, 'NSTP 1', 'Reserve Officers\' Training Corps 1', 'Practical', 3, 150),
...
--
ALTER TABLE `regissection`
  MODIFY `regisSectionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
